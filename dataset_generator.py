...
if scenario == 1:
    """For three way band-join scenario with an equi-join
    R [x,y] [int,float]
    ...
    """For three way band-join scenario without an equi-join
    R [x,y] [int,float]
    S [a,b,c,d] [int,float,double,int]
    T [e,f] [double,int]
    ...
    """For four way band-join scenario without an equi-join
    R [x,y] [int,float]
    S [a,b,c,d] [int,float,double,int]
    T [e,f,g,h] [double,int,float,int]
    U [k,l] [float,int]
    ...
    e = np.random.uniform(range_min,range_max, size)
    f = np.random.randint(range_min,range_max, size)
    g = np.random.uniform(range_min,range_max, size)
    h = np.random.randint(range_min,range_max, size)

    # Stream U
    k = np.random.uniform(range_min,range_max, size)
    l = np.random.randint(range_min,range_max, size)
    ...
    for i in range(size):
        R.write(sep.join([str(x[i]),str(y[i])]) + '\n')
        S.write(sep.join([str(a[i]),str(b[i]),str(c[i]),str(d[i])]) + '\n')
        T.write(sep.join([str(e[i]),str(f[i]),str(g[i]),str(h[i])]) + '\n')
        U.write(sep.join([str(k[i]),str(l[i])]) + '\n')
